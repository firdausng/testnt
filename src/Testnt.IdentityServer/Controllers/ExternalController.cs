    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            if (user == null)
            {
                ...
                _logger.LogWarning("User '{UserId}' with email '{UserEmail}' from '{Provider}' cannot be find in database", providerUserId, email, provider);
                return Redirect("~/identity/account/UnauthenticatedUser");
            }
            ...
            FindUserFromExternalProviderAsync(AuthenticateResult result)
        {
            ...
            if (user == null)
            {
                ...
                if (user == null)
                {
                    ...
                    if (prefname != null)
                    {
                        user = await userManager.FindByNameAsync(prefname);
                    }
                }
                if (user == null)
                {
