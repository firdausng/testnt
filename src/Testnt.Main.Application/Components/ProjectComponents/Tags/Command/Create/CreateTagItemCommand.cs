...
{
    public class CreateTagItemCommand : ProjectComponentRequest, IRequest<CreateTestTagItemDto>
    {
        public string Name { get; set; }
        public ICollection<Guid> TestScenarioIds { get; set; }

        public class CreateTestTagItemCommandHandler : IRequestHandler<CreateTagItemCommand, CreateTestTagItemDto>
        {
