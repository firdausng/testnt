...
namespace Testnt.Main.Domain.Policies
{
    public enum Permissions : short
    {
        ...
        ProjectCreate = 0x11,
        [Display(GroupName = "Project", Name = "Update", Description = "Can update a Project entry")]
        ProjectUpdate = 0x12,
        [Display(GroupName = "Project", Name = "Delete", Description = "Can delete a Project entry")]
        ProjectDelete = 0x13,
        ...
        FeatureCreate = 0x21,
        [Display(GroupName = "Feature", Name = "Update", Description = "Can update a Feature entry")]
        FeatureUpdate = 0x22,
        [Display(GroupName = "Feature", Name = "Delete", Description = "Can delete a Feature entry")]
        FeatureDelete = 0x23,
