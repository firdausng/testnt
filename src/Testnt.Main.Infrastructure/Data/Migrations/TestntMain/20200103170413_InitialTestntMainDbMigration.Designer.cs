...
namespace Testnt.Main.Infrastructure.Data.Migrations.TestntMain
{
    ...
    [Migration("20200103170413_InitialTestntMainDbMigration")]
    partial class InitialTestntMainDbMigration
    {
            ...
            modelBuilder.Entity("Testnt.Main.Domain.Entity.TestScenario", b =>
                {
                    ...
                    b.HasIndex("TestProjectId")
                        .HasName("IX_TestOutlines_TestProjectId1");
            ...
            modelBuilder.Entity("Testnt.Main.Domain.Entity.TestScenario", b =>
                {
                    b.HasOne("Testnt.Main.Domain.Entity.TestProject", "TestProject")
                        ...
                        .HasForeignKey("TestProjectId")
                        .HasConstraintName("FK_TestOutlines_Projects_TestProjectId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
